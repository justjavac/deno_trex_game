...
Runner.spriteDefinitionByType = {
  ...
  type_1: {
    ...
    TREX: {
      ...
      COLLISION_BOXES: [
        new CollisionBox(22, 0, 17, 16),
        new CollisionBox(0, 16, 32, 9),
        new CollisionBox(3, 24, 27, 6),
        new CollisionBox(5, 30, 21, 4),
      ],
    },
    OBSTACLES: [
      {
        ...
        minSpeed: 0,
        collisionBoxes: [
          new CollisionBox(0, 0, 3, 26),
          new CollisionBox(3, 5, 8, 31),
      ...
      },
      {
        ...
        minSpeed: 7.5,
        collisionBoxes: [
          new CollisionBox(0, 0, 4, 26),
          new CollisionBox(4, 3, 26, 31),
  ...
  type_3: {
    ...
    TREX: {
      ...
      COLLISION_BOXES: [
        new CollisionBox(28, 35, 19, 11),
        new CollisionBox(3, 44, 26, 4),
      ],
    },
    OBSTACLES: [
      {
        ...
        minSpeed: 0,
        collisionBoxes: [
          new CollisionBox(11, 2, 3, 2),
          new CollisionBox(7, 4, 11, 10),
      ...
      },
      {
        ...
        minSpeed: 0,
        collisionBoxes: [
          new CollisionBox(4, 16, 5, 8),
          new CollisionBox(9, 12, 7, 12),
      ...
      },
      {
        ...
        collisionBoxes: [
          ...
          new CollisionBox(16, 5, 10, 19),
          new CollisionBox(26, 14, 13, 11),
          new CollisionBox(40, 18, 10, 6),
          new CollisionBox(50, 12, 10, 12),
  ...
  type_4: {
    ...
    TREX: {
      ...
      COLLISION_BOXES: [
        new CollisionBox(17, 4, 49, 9),
        new CollisionBox(20, 17, 23, 4),
        new CollisionBox(19, 20, 10, 7),
        new CollisionBox(17, 13, 42, 4),
      ],
    },
    OBSTACLES: [
      {
  ...
  type_5: {
    ...
    TREX: {
      ...
      COLLISION_BOXES: [
        new CollisionBox(35, 30, 13, 9),
        new CollisionBox(19, 51, 22, 9),
        new CollisionBox(9, 51, 9, 13),
